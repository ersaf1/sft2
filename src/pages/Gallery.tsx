const Gallery = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            ...
            <div className="mb-16">
                <h2 className="text-3xl font-bold text-center mb-8">Dokumentasi Foto</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {[...Array(12)].map((_, index) => (
                        <div
                            key={index}
                            className="aspect-square bg-gradient-to-br from-primary/20 to-secondary/20 rounded-lg flex items-center justify-center cursor-pointer hover:scale-105 transition-transform"
                        >
                            <div className="text-center">
                                ...
                                <p className="text-xs text-gray-500 mt-2">Photo {index + 1}</p>
                            </div>
                        </div>
                    ))}
                </div>
            ...
            {/* Video Section */}
            <div className="mb-16">
                <h2 className="text-3xl font-bold text-center mb-8">Video Dokumentasi</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[1, 2, 3, 4].map((index) => (
                        <div
                            key={index}
                            className="aspect-video bg-gradient-to-br from-secondary/20 to-accent/20 rounded-lg flex items-center justify-center cursor-pointer hover:scale-105 transition-transform"
                        >
                            <div className="text-center">
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    className="h-20 w-20 mx-auto text-secondary/50"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                >
                                ...
                                <p className="text-sm text-gray-500 mt-2">Video Dokumentasi {index}</p>
                            </div>
                        </div>
                    ))}
                </div>
